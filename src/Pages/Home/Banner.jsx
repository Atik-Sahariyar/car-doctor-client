            ...
            <div id="slide1" className="carousel-item relative w-full  h-[600px]">
                ...
                <div className="absolute rounded-xl flex items-center h-full  bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className=" text-white w-1/3 pl-12">
                        <div >
                            <h2 className=" text-5xl text-white my-5">Affordable Price For Car Servicing</h2>
                ...
                <div className="absolute flex justify-between transform -translate-y-1/2 left-auto gap-3 right-5 bottom-0    ">
